const generateOtpEmail = (fullName, otp) => {
    return `
        <div style="font-family: 'Comic Sans MS', cursive, sans-serif; line-height: 1.6; color: #333; background-color: #f2f2f2; padding: 20px; border-radius: 8px;">
          ...
          <p style="font-size: 16px; color: #555; text-align: center;">You're just one step away. !</p>
          ...
          <p style="font-size: 14px; color: #555; text-align: center;">If you didn’t request this, no worries—just ignore it.</p>
          <br />
          <p style="font-size: 16px; color: #555; text-align: center;">Looking forward to having you onboard in the system!</p>
